...
export async function insertWork_Vehicle(dataWorkV){
   const db = await connect()
   const result = await db.query(`INSERT INTO work_vehicles (id_work, id_vehicle, km_begin, km_end, date)
   VALUES( ${dataWorkV.id_work}, ${dataWorkV.id_vehicle} , ${dataWorkV.km_begin}, ${dataWorkV.km_end} , ${dataWorkV.date})`)
   return result.recordsets
}
